      ...
      <nav className=" ">
        ...
        {!isSignedIn ? (
          <div>
            ...
            <button className="btn"><Link href={"/sign-in"}>Sign-In </Link></button>
        ...
        <ul className="mt-6 p-8">
          <li className="">
            <div className="dropdown dropdown-hover">
              ...
              >
                <li>
                <Link href={"categories/phones/apple"}>Apple</Link>
                </li>
                <li>
                <Link href={"categories/phones/samsung"}>Samsung</Link>
                </li>
                <li>
                <Link href={"categories/phones/google"}>Google</Link>
                </li>
              </ul>
            </div>
          </li>
